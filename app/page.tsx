  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <motion.div
          className="absolute -left-40 -top-40 h-[600px] w-[600px] rounded-full bg-gradient-to-r from-gray-600/30 to-gray-500/30 blur-3xl"
          animate={{
        ...
        />
        <motion.div
          className="absolute -bottom-40 -right-40 h-[600px] w-[600px] rounded-full bg-gradient-to-r from-gray-700/30 to-gray-600/30 blur-3xl"
          animate={{
            x: -mousePosition.x * 0.02,
            y: -mousePosition.y * 0.02,
          }}
        ...
        />
        <motion.div
          className="absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-slate-600/25 to-slate-500/25 blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 90, 0],
          }}
      ...
      <section className="relative px-4 py-20 md:py-32">
        <div className="container mx-auto">
          ...
          >
            ...
            <motion.h1
              variants={fadeInUp}
              className="mb-6 bg-gradient-to-br from-foreground via-foreground to-foreground/60 bg-clip-text text-5xl font-bold leading-tight tracking-tight text-transparent md:text-7xl"
            >
            ...
            >
              ...
              handling finances, and generating reports. Everything you need in
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              ...
              <motion.div variants={scaleIn} className="relative">
                <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-gradient-to-br from-card/80 to-card/40 p-8 backdrop-blur-sm">
                  <div className="absolute -right-20 -top-20 h-60 w-60 rounded-full bg-gradient-to-br from-primary/20 to-purple-500/20 blur-3xl" />
